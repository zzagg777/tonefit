...
| 환경 | URL |
|------|-----|
| Vercel (Preview) | https://tonefit-six.vercel.app |
| AWS (Production) | https://tonefit.kr |
...
`.env.local` 파일을 프로젝트 루트에 생성 후 설정합니다.

```env
# API 서버 URL (예: http://localhost:8080/api/v1 또는 /api/v1)
VITE_API_URL=

# Amplitude Analytics API Key
VITE_AMPLITUDE_API_KEY=

# MSW Mock 사용 여부 (true: Mock 데이터 / false: 실제 API 서버)
VITE_USE_MSW=true

# Correction Mock 범위
# true: corrections도 Mock / false: 익명토큰만 Mock, corrections는 실제 서버
VITE_MOCK_CORRECTIONS=true
```
